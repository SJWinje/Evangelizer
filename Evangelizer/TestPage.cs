	...
	{	
		...
		public TestPage ()
		{
			...
			dictionary.Add ("What should I do?", 
				new Scripture("What should I do?",
			...
			// Add heading
			Label heading = new Label { Text = "Quest for Joy", HorizontalOptions = LayoutOptions.CenterAndExpand };
			...
			add = new Button { Text = dictionary["What should I do?"].Reference() };
			add.Clicked += OnButtonClicked;
			parent.Children.Add (add);
